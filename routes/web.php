...
Route::prefix('competitions')->name('competitions.')->group(function () {
    ...
    Route::post('create', [CompetitionsController::class, 'save'])->name('create')->middleware(SecretaryOnlyAccess::class);
    ...
    Route::get("edit/{id}", [CompetitionsController::class, "edit"])->name("edit")->middleware(SecretaryOnlyAccess::class);
});
