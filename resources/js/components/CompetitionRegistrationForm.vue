                ...
                <div class="border-b border-gray-900/10 pb-6">
                    <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                        ...
                        <div class="sm:col-span-3">
                            <label for="sport_school" class="block text-sm/6 font-medium text-gray-900">Спортивная
                                школа</label>
                            <div class="mt-2">
                        ...
                        <div class="sm:col-span-3">
                            <label for="sport_organisation" class="block text-sm/6 font-medium text-gray-900">Спортивный
                                клуб или организация</label>
                            <div class="mt-2">
                        ...
                        <div class="sm:col-span-6">
                            ...
                            <template v-for="group in competition_copy.groups">
                                <br/>
                                <div v-if="group.allowed_genders.includes(athlete.gender) || athlete.gender === ''">

                                    <div class="group grid size-4 grid-cols-1">
                                        <input v-model="group.participation" id="participation_{{group.id}}"
                                    ...
                                    <div class="text-sm/6">
                                        <label for="advertisement"
                                               class="font-medium text-gray-900">{{ group.division.title }}
                                            {{ group.archery_class.title }}</label>
                                    </div>
                                    <div v-if="group.includes_teams == 1">
                                        Участвую в командных соревнованиях
                                        <div class="group grid size-4 grid-cols-1">
                                            <input v-model="group.participate_teams" id="participation_team_{{group.id}}"
                                                   aria-describedby="advertisement-description" name="advertisement"
                                                   type="checkbox"
                                                   class="col-start-1 row-start-1 appearance-none rounded-sm border border-gray-300 bg-white checked:border-indigo-600 checked:bg-indigo-600 indeterminate:border-indigo-600 indeterminate:bg-indigo-600 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600 disabled:border-gray-300 disabled:bg-gray-100 disabled:checked:bg-gray-100 forced-colors:appearance-auto"/>
                                            <svg
                                    ...
                                    <div v-if="group.includes_mixed_teams == 1">
                                        Участвую в соревнованиях команд-микс
                                        <div class="group grid size-4 grid-cols-1">
                                            <input v-model="group.participate_mixed_teams" id="participation_mixed_team_{{group.id}}"
                                                   aria-describedby="advertisement-description" name="advertisement"
                                                   type="checkbox"
                                                   class="col-start-1 row-start-1 appearance-none rounded-sm border border-gray-300 bg-white checked:border-indigo-600 checked:bg-indigo-600 indeterminate:border-indigo-600 indeterminate:bg-indigo-600 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600 disabled:border-gray-300 disabled:bg-gray-100 disabled:checked:bg-gray-100 forced-colors:appearance-auto"/>
                                            <svg
                        ...
                        <div class="sm:col-span-3">
                            <label for="contact_info" class="block text-sm/6 font-medium text-gray-900">Контактная
                                информация</label>
                            <div class="mt-2">
                        ...
                        <div class="sm:col-span-3">
                            <label for="coach_name" class="block text-sm/6 font-medium text-gray-900">Тренер</label>
                            <div class="mt-2">
