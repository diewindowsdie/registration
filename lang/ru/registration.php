...
return [
    ...
    "contactInfo" => "Контактная информация спортсмена",
    "coachInfo" => "Тренер или представитель команды и его контактная информация",
    "bornM" => "родился",
    "bornF" => "родилась",
    ...
    "personalDataProcessing.prefix" => 'Я согласен(а) с ',
    "personalDataProcessing.text" => 'политикой обработки и хранения персональных данных',

    "error.namePattern" => "Буквы, одинарные кавычки и дефис, один символ и больше",
    "error.patronymic" => "Буквы, одинарные кавычки и дефис, один символ и больше. Если у вас нет отчества, поставьте галочку выше.",
    ...
    "error.coachInfo" => "Укажите тренера или представителя команды, и как можно с ним связаться",
